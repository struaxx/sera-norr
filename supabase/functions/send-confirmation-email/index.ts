...
<div class="cta"><a href="${body.shareUrl}">Bekijk uw ontwerp</a></div>
...
function buildAdminHtml(body: EmailRequest): string {
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Nieuwe aanvraag - ${body.buildCode}</title>
<style>
...
<div class="cj">${JSON.stringify(body.configuration, null, 2)}</div>
</body></html>`;
}
