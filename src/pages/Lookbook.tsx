...
const lookbookItems = [
  { id: 1, title: 'Eettafel Ovaal', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: '240×100 cm', image: '/lookbook/marble-oval-dining.webp' },
  { id: 2, title: 'Ronde Eettafel', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: 'Ø130 cm', image: '/lookbook/travertine-round-fluted.webp' },
  { id: 3, title: 'Ronde Eettafel', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: 'Ø140 cm', image: '/lookbook/travertine-round-cone.webp' },
  { id: 4, title: 'Salon Set', stone: 'Calacatta Viola & Travertijn', useCase: 'Woonkamer', dimensions: 'Ø120 + Ø80 cm', image: '/lookbook/marble-round-livingroom.webp' },
  { id: 5, title: 'Ronde Eettafel', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: 'Ø150 cm', image: '/lookbook/calacatta-viola-round.webp' },
  { id: 6, title: 'Eettafel Ovaal', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: '220×110 cm', image: '/lookbook/travertine-oval-slab.webp' },
  { id: 7, title: 'Console Marmer', stone: 'Calacatta Viola', useCase: 'Hal', dimensions: '160×40 cm', image: '/lookbook/marble-oval-fluted.webp' },
  { id: 8, title: 'Bijzettafel', stone: 'Travertijn', useCase: 'Zithoek', dimensions: 'Ø45 cm', image: '/lookbook/travertine-coffee-fluted.webp' },
  { id: 9, title: 'Statement Console', stone: 'Calacatta Viola', useCase: 'Entree', dimensions: '180×45 cm', image: '/lookbook/marble-coffee-fluted.webp' },
  { id: 10, title: 'Sculptural Side', stone: 'Calacatta', useCase: 'Slaapkamer', dimensions: 'Ø50 cm', image: '/lookbook/marble-round-fluted.webp' },
  { id: 11, title: 'Grand Dining', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: '280×110 cm', image: '/lookbook/travertine-oval-fluted.webp' },
  { id: 12, title: 'Petit Console', stone: 'Travertijn', useCase: 'Hal', dimensions: '120×35 cm', image: '/lookbook/travertine-coffee-set.webp' },
  // New photos
  { id: 13, title: 'Fluted Round', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: 'Ø120 cm', image: '/lookbook/hf_20260302_192947_bf2d5c2a-accf-4eab-91f9-6c9e232a8ca9.webp' },
  { id: 14, title: 'Viola Dining', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: '260×110 cm', image: '/lookbook/hf_20260302_193457_5241fec0-6f29-443e-8611-215c123acaf1.webp' },
  { id: 15, title: 'Sculptural Base', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: 'Ø140 cm', image: '/lookbook/hf_20260302_193517_2927dca0-dc35-42d3-8ebc-96aa8765aa6c.webp' },
  { id: 16, title: 'Terra Cylinder', stone: 'Travertijn', useCase: 'Zithoek', dimensions: 'Ø40 cm', image: '/lookbook/hf_20260302_193525_76bc9c3a-11ea-468b-b16c-eeec413641ca.webp' },
  { id: 17, title: 'Grand Oval', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: '240×120 cm', image: '/lookbook/hf_20260302_193532_4c68463b-e3dd-49e2-941a-e0c0f60f4afb.webp' },
  { id: 18, title: 'Viola Salon', stone: 'Calacatta Viola', useCase: 'Woonkamer', dimensions: 'Ø90 cm', image: '/lookbook/hf_20260302_193814_33d614cc-9ed5-4e85-81cb-0a3d33634771.webp' },
  { id: 19, title: 'Fluted Console', stone: 'Travertijn', useCase: 'Hal', dimensions: '150×40 cm', image: '/lookbook/hf_20260302_193827_5a71d56c-3f4a-48ac-9040-fd839818e611.webp' },
  { id: 20, title: 'Duo Set', stone: 'Calacatta Viola', useCase: 'Woonkamer', dimensions: 'Ø100 + Ø60 cm', image: '/lookbook/hf_20260302_193938_bc08d013-b022-4ec3-96ab-5006204810c6.webp' },
  { id: 21, title: 'Terra Pedestal', stone: 'Travertijn', useCase: 'Entree', dimensions: 'Ø35 cm', image: '/lookbook/hf_20260302_193948_92c5aa02-a535-40c6-b836-5a8d17caefed.webp' },
  { id: 22, title: 'Ribbed Dining', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: 'Ø150 cm', image: '/lookbook/hf_20260302_194905_1f39a000-891d-4b16-aef9-02f8443a887b.webp' },
  { id: 23, title: 'Viola Statement', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: '220×100 cm', image: '/lookbook/hf_20260302_194910_7db0cac4-07f6-46aa-ae79-7b4c3078d449.webp' },
  { id: 24, title: 'Terra Slab Side', stone: 'Travertijn', useCase: 'Zithoek', dimensions: '50×40 cm', image: '/lookbook/hf_20260302_194922_d503480e-9df6-4cde-a61b-cb9d6f776e3c.webp' },
  { id: 25, title: 'Arch Dining', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: '240×110 cm', image: '/lookbook/hf_20260302_194927_0ddf7cfd-6888-4e9c-b499-7cdca489110e.webp' },
  { id: 26, title: 'Cone Coffee', stone: 'Travertijn', useCase: 'Woonkamer', dimensions: 'Ø80 cm', image: '/lookbook/hf_20260302_195406_c9467450-e5a7-40e7-a4e6-b3053747232b.webp' },
  { id: 27, title: 'Viola Round XL', stone: 'Calacatta Viola', useCase: 'Eetkamer', dimensions: 'Ø180 cm', image: '/lookbook/hf_20260302_195410_0a0fa54f-3736-407b-8463-9eab503b8efb.webp' },
  { id: 28, title: 'Stacked Console', stone: 'Travertijn', useCase: 'Hal', dimensions: '140×35 cm', image: '/lookbook/hf_20260302_195415_9bfd5a3b-8d26-426f-8a03-dd5e617e4d83.webp' },
  { id: 29, title: 'Viola Nest', stone: 'Calacatta Viola', useCase: 'Slaapkamer', dimensions: 'Ø45 + Ø35 cm', image: '/lookbook/hf_20260302_195421_fc214e7f-6dcd-46f8-9843-775188d1e8df.webp' },
  { id: 30, title: 'Terra Grand', stone: 'Travertijn', useCase: 'Eetkamer', dimensions: '280×120 cm', image: '/lookbook/hf_20260302_195442_6ac8dcca-0aac-451d-981e-bd80eeccce5b.webp' },
];
