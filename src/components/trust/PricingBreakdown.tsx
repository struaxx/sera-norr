...
const EXAMPLES: Example[] = [
  {
    ...
    swatch: 'bg-[#EFE8EA]',
    items: [
      { label: { nl: 'Slab Calacatta Viola', en: 'Calacatta Viola slab' }, amount: 4200 },
      { label: { nl: 'Bookmatching & polish', en: 'Bookmatching & polish' }, amount: 850 },
      { label: { nl: 'Conische marmer poten', en: 'Tapered marble legs' }, amount: 1450 },
      { label: { nl: 'Atelierwerk · 45 uur', en: 'Atelier hours · 45h' }, amount: 1150 },
      { label: { nl: 'Transport & levering', en: 'Transport & delivery' }, amount: 350 },
      { label: { nl: 'Eindcontrole & oplevering', en: 'Final inspection' }, amount: 500 },
    ],
  },
  {
    id: 'le-dining-200',
    title: { nl: 'Light Emperador — Eettafel', en: 'Light Emperador — Dining table' },
    subtitle: { nl: '200×100 cm · stalen onderstel', en: '200×100 cm · steel base' },
    total: 3500,
    swatch: 'bg-[#C9B7A2]',
    items: [
      { label: { nl: 'Slab Light Emperador', en: 'Light Emperador slab' }, amount: 1450 },
      { label: { nl: 'CNC-bewerking & polish', en: 'CNC & polish' }, amount: 580 },
      { label: { nl: 'Stalen onderstel', en: 'Steel base' }, amount: 420 },
      { label: { nl: 'Atelierwerk · 28 uur', en: 'Atelier hours · 28h' }, amount: 720 },
      { label: { nl: 'Transport & levering', en: 'Transport & delivery' }, amount: 280 },
      { label: { nl: 'Eindcontrole & oplevering', en: 'Final inspection' }, amount: 50 },
    ],
  },
  {
    id: 'cv-coffee',
    title: { nl: 'Calacatta Viola — Koffietafel', en: 'Calacatta Viola — Coffee table' },
    subtitle: { nl: 'Massieve marmer voet', en: 'Solid marble base' },
    total: 2500,
    swatch: 'bg-[#EFE8EA]',
    items: [
      { label: { nl: 'Slab Calacatta Viola', en: 'Calacatta Viola slab' }, amount: 1250 },
      { label: { nl: 'Bookmatching & polish', en: 'Bookmatching & polish' }, amount: 340 },
      { label: { nl: 'Massieve marmer voet', en: 'Solid marble base' }, amount: 420 },
      { label: { nl: 'Atelierwerk · 18 uur', en: 'Atelier hours · 18h' }, amount: 340 },
      { label: { nl: 'Transport & levering', en: 'Transport & delivery' }, amount: 150 },
    ],
  },
];
